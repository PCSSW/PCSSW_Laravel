...
class controllerQuiz extends Controller
{
    ...
    public function dadosPagina6(Request $request){
        ...
        if($acertos == 5)
            $dados['mensagem'] = "Excelente!! Você acertou todas!!";
        else if ($acertos > 3)
            $dados['mensagem'] = "Ótimo!! Você acertou" . $acertos . "de 5!! Parabéns!!";
        else if ($acertos == 3)
            $dados['mensagem'] = "Bom!! Você acertou 50% do quiz!!";
        else
            $dados['mensagem'] = "Precisa se inteirar mais sobre o conteúdo! Você acertou" . $acertos . "de 6. Estude mais e tente novamente mais tarde!";
